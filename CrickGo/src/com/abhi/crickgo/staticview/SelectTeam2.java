...
public class SelectTeam2 extends JInternalFrame implements ItemListener,
		ActionListener {
	...
	public SelectTeam2() {
		super("Select Team2", false, true, false, true);
		if (StaticData.team1Name != null) {
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == btnDone) {
			...
			StaticData.team2Name = cbTeams.getSelectedItem().toString();
			...
			if (isValid) {
				StaticData.team2 = new ArrayList<String>(batList);
				StaticData.team2.addAll(bowlerList);
				StaticData.team2.addAll(wkList);
				StaticData.team2.addAll(arList);
				JOptionPane.showMessageDialog(this, StaticData.team2Name
						+ " selected as team2");
			} else {
				JOptionPane
						.showMessageDialog(this,
								"Your team selection not as per the rules.\n Please see Team combination hint!");
			}
		}
